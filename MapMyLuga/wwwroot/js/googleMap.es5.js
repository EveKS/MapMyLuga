    ...
    $.ajax({
        ...
        success: function success(data) {
            if (data !== null && data.search('error') === -1) {
                ...
                $('#panel-content').html(data).addClass("info-map-panel-visible");
...
function initMap() {
    ...
    function getMap(pos) {
        ...
        $("#message").html("Информация о вашем местоположении:<br/>Позиция определена с точностью в " + pos.coords.accuracy + " метров.<br/>" + "Ваши координаты: " + pos.coords.latitude + " широта, " + pos.coords.longitude + " долгота.");
